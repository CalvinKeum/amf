...
/**
 * Provides the local service interface for AMFTrackEventEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Calvin Keum
 * @see AMFTrackEventEntryLocalServiceUtil
...
public interface AMFTrackEventEntryLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AMFTrackEventEntryLocalServiceUtil} to access the amf track event entry local service. Add custom service methods to {@link com.liferay.amf.service.impl.AMFTrackEventEntryLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
